        ...
        extends AppCompatActivity
{
    ...
    private String matchName, matchGender, matchFavorite, matchProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        matchGender = getIntent().getExtras().getString("gender");
        matchFavorite = getIntent().getExtras().getString("favorite");
