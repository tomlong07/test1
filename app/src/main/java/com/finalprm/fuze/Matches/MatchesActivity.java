...
import com.finalprm.fuze.Main.MainActivity;
...
public class MatchesActivity extends AppCompatActivity {
    ...
    private void getUserMatchId() {
        Query sortedMatchesByLastTimeStamp = FirebaseDatabase.getInstance("https://fuze-c6271-default-rtdb.asia-southeast1.firebasedatabase.app/")
    ...
    private void getChatID(String chatId) {
        DatabaseReference mChatDB = FirebaseDatabase.getInstance("https://fuze-c6271-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Chat").child(chatId).child("info");
    ...
    private void getUserData(User mUser) {
        DatabaseReference mUserDb = FirebaseDatabase.getInstance("https://fuze-c6271-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("User").child(mUser.getUserId());
    ...
    private void FetchMatchInformation(final String key, final String chatid) {
        DatabaseReference userDb = FirebaseDatabase.getInstance("https://fuze-c6271-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Users").child(key);
